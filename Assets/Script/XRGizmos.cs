...
namespace Utilities.XR
{
    public static partial class XRGizmos
    {
        ...
        /// <summary>
        ///   <para>Draw a rectangle which last to the second hit.</para>
        /// </summary>
        /// <param name="color" ></param>
        /// <param name="from"></param>
        /// <param name="to"></param>
        /// <param name="lineThickness"></param>
        //[Conditional(k_XRGizmosDefine)]
        //public static void DrawRectangleBase(Vector3 from, Vector3 to, Color color, float lineThickness = k_LineThickness)
        //{
        //    if (!TryGetLineMatrix(from, to, lineThickness, out var matrix))
        //    {
        //        return;
